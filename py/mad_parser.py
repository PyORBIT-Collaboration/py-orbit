...
class LattElement:
    ...
    def __init__(self,name,Tname):
        ...
        self.__name = name
        self.__type = _typeChecker.checkType(Tname)
        self.__par = {}
...
class MADparser:
    ...
    def parse(self,MADfileName):
        ...
        #---------------------------------------------
        for accElm in self.__accElements:
            lattElm = LattElement(accElm.getName(),accElm.getElementType())
        ...
        lattLineDict = {}
        for accLine in self.__accLines:
            lattLine = LattLine(accLine.getName())
    ...
    def clear(self):
        """
        Method. It removes all MAD information.
        """
        self.__madLines =  []
        self.__accValues = []
        self.__accElements = []
    ...
    def getMADLines(self):
        """
        Method. It returns the lattice lines
        that are defined in the MAD file.
        """
        lattLineDict = {}
        for lattLine in self.__lattLines:
            lattLineDict[lattLine.getName()] = lattLine
        return lattLineDict

    def getMADElements(self):
        """
        Method. It returns the lattice elements
        that are defined in the MAD file.
        """
        lattElmDict = {}
        for lattElm in self.__lattElems:
            lattElmDict[lattElm.getName()] = lattElm
        return lattElmDict
