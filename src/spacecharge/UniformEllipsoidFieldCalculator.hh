...
class UniformEllipsoidFieldCalculator: public OrbitUtils::CppPyWrapper
{
  ...
  void setIntegralPointsNumber(int nPoints);
  ...
  private:
    ...
    double integralPhi(double a_2, double b_2, double c_2, double start_s, double stop_s);
	...
	private:
		...
		//function with gauss_legendre points and weghts for the interval [0,1.0]
		OrbitUtils::Function* uiFunc; 
		...
		int order_of_integration_limit;
