...
def setSC2p5D_General_AccNodes(lattice, sc_path_length_min, space_charge_calculator, SC_NodeConstructor):
	"""
...
def setSC2p5DAccNodes(lattice, sc_path_length_min, space_charge_calculator, boundary = None):
	...
	"""
	scNodes_arr = setSC2p5D_General_AccNodes(lattice, sc_path_length_min, space_charge_calculator, SC2p5D_AccNode)
