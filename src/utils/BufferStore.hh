...
/**
  ...
  that keeps sets of one dimensional arrays. 
	They will be used in MPI data exchanges.
*/
...
namespace OrbitUtils{
	...
	public:
		...
		After usage the array should be freed by setUnusedDoubleArr(index) method.
		*/
		...
		*/
		...
		After usage the array should be freed by setUnusedCharArr(index)  method.
		*/	
