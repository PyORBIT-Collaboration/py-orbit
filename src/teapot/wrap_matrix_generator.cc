...
extern "C" {
	...
	static PyObject* MatrixGenerator_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
	{
		pyORBIT_Object* self;
  ...
  static int MatrixGenerator_init(pyORBIT_Object *self, PyObject *args, PyObject *kwds){
  ...
  static PyObject* MatrixGenerator_step_get_set(PyObject *self, PyObject *args){
  ...
  static PyObject* MatrixGenerator_initBunch(PyObject *self, PyObject *args){
    pyORBIT_Object* pyMatrixGenerator = (pyORBIT_Object*) self;
		MatrixGenerator* cpp_MatrixGenerator = (MatrixGenerator*) pyMatrixGenerator->cpp_obj;
		PyObject *pyIn;
  ...
  static PyObject* MatrixGenerator_calcMatrix(PyObject *self, PyObject *args){
    pyORBIT_Object* pyMatrixGenerator = (pyORBIT_Object*) self;
		MatrixGenerator* cpp_MatrixGenerator = (MatrixGenerator*) pyMatrixGenerator->cpp_obj;
		PyObject *pyInB;
		PyObject *pyInM;
		...
		if((!PyObject_IsInstance(pyInB,pyBunchType)) || (!PyObject_IsInstance(pyInM,pyORBIT_Matrix_Type))){
  ...
  static PyMethodDef MatrixGeneratorClassMethods[] = {
	...
	// defenition of the memebers of the python MatrixGenerator wrapper class
	// they will be vailable from python level
  ...
  void initMatrixGenerator(PyObject* module){
		...
		PyModule_AddObject(module, "MatrixGenerator", (PyObject *)&pyORBIT_MatrixGenerator_Type);
	}
